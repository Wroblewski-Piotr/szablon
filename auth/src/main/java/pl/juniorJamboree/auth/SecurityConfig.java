...
import pl.juniorJamboree.auth.filters.CustomAuthenticationFilter;
import pl.juniorJamboree.auth.filters.CustomAuthorizationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/static/**", "/resources/**", "/resources/static/**")
                                .permitAll()
                                .anyRequest()
                                .permitAll())
                .addFilterBefore(
